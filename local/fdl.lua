...
--[[
local tResult, strError = tFDL:fdl2prettyPrint(tFDLContents)
if tResult==nil then
  error('Failed to pretty print the FDL:' .. tostring(strError))
else
  print(tResult)
end
--]]
...
--[[
local tJson = tFDL:fdl2json(tFDLContents)
...
local tPatches = {
  tOEMIdentification = {
    aucOEMOrderNumber = "1912.103",
    aucOEMSerialNumber = "20124"
  },
  atMacCOM = {
    { aucMAC = "123456" },
    { aucMAC = "234567" },
